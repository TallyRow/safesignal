...
- [ ] T058 [US5] Implement `ConfiguredRuntime` and the module-scoped active-runtime slot in `src/runtime/configured-runtime.ts` and `src/runtime/runtime-ref.ts`; update `data-model.md` to document the new entities
